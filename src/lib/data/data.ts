...
export const heroInfos = {
	...
	shortDescription:
		'Developer with 3 years of experience in front-end development using Svelte/SvelteKit, specializing in high-performance applications. Back-end experience in API development, relational and non-relational database, and authentication (Auth). Focused on delivering complete, optimized, and scalable solutions, crafting efficient systems that transform complex problems into simple and intuitive experiencesx. I’m not just a programmer; I like to contribute with ideas and create ideas to start a project.'
};
...
export const techs = {
	...
	database: ['SQL', 'Prisma', "Supabase", "PostgreSQL", "MongoDB", "SQLite"],
	tools: ['Git', 'Figma']
};
...
export const projects = [
	{
		name: 'Hot Rod Fades',
		tags: ['SvelteKit', 'Tailwindcss', 'Splide', 'DaisyUI'],
		href: 'https://barbershop-omega-topaz.vercel.app/',
		date: '17/01/2025',
		text: 'This project was the first freelance job I participated in.'
	},
	{
		name: 'Bot Shopie',
		tags: ['React', 'Sass'],
	...
	},
	{
		name: 'To Do',
		tags: ['React'],
		href: 'https://todo-react-rosy-seven.vercel.app/',
		date: '21/04/2024',
		text: 'I built a to-do list with React to practice state management concepts, component structure, and user interactions.'
	},
	{
		name: 'Pokedex',
		tags: ['Next.js'],
...
export const contact =
	'I’m available for new projects and opportunities. If you have an idea, need someone to develop a modern and functional website, or just want to chat about a project, feel free to reach out';
